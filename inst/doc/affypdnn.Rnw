...
is then just a matter of calling of the functions
\Rfunction{pmcorrect.pdnnpredict}, 
\Rfunction{pmcorrect.pdnn}:
...
showed its limitation with the requirements for this one package,
